...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(greenrock, rock0.DrawRectangle, Color.White);
            spriteBatch.Draw(magentarock, rock1.DrawRectangle, Color.White);
            spriteBatch.Draw(whiterock, rock2.DrawRectangle, Color.White);
        ...
        private Vector2 GetRandomVelocity()
        {
            ...
            int speed = rand.Next(2, 6); //Speed will be an int ranging 1 to 5
